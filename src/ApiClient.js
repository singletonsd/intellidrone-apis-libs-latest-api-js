...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.intellidrone_api_client_js.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default http://web.robotagro.com/api/latest
     */
    this.basePath = 'http://web.robotagro.com/api/latest'.replace(/\/+$/, '');
