...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new intellidrone_api_client_js.UploadResponse();
  });
  ...
  describe('UploadResponse', function() {
    ...
    it('should have the property actividadesInsertadas (base name: "actividades_insertadas")', function() {
      // uncomment below and update the code to test the property actividadesInsertadas
      // var instance = new intellidrone_api_client_js.UploadResponse();
      // expect(instance).to.be();
    });

    it('should have the property nuevasVacas (base name: "nuevas_vacas")', function() {
      // uncomment below and update the code to test the property nuevasVacas
      // var instance = new intellidrone_api_client_js.UploadResponse();
      // expect(instance).to.be();
    });

    it('should have the property lineasConError (base name: "lineas_con_error")', function() {
